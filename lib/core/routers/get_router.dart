...
import 'package:debateseason_frontend_v1/features/profile/presentation/views/profile_policy_page.dart';
...
class GetRouter {
  static final getPages = [
    ...
    GetPage(
      name: GetRouterName.profilePolicy,
      page: () => ProfilePolicyPage(),
    ),
    GetPage(
